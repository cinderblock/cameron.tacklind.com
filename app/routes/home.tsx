    ...
    <main className="page">
      <section id="hero" className="snap hero">
        ...
        <button
          ...
          onClick={() => scrollToId("roboticist")}
        >
          <ChevronDown size={28} aria-hidden="true" />
        </button>
      </section>

      <section id="roboticist" className="snap section section-photo-left">
        <div className="section-inner">
          <figure className="section-figure">
            <img
              src="/placeholders/roboticist.svg"
              alt="Placeholder for robotics work — swap in a photo of a robot, motor, or control system."
              loading="lazy"
            />
          </figure>
          <div className="section-copy">
            ...
            <p className="section-lede">
              From BLDC motor control to Kalman filters and full-state estimators.
            </p>
            <p className="section-body">
              Medical, wearable, commercial, home, whimsy, and art.
              Real-time control across every domain that moves.
            </p>
            <a
              className="cta"
              href="https://www.npmjs.com/package/react-smoothie"
              target="_blank"
              rel="noopener noreferrer"
            >
              Realtime charts on npm <ArrowUpRight size={18} aria-hidden="true" />
            </a>
          </div>
        </div>
      </section>

      <section id="artist" className="snap section section-photo-right">
        <div className="section-inner">
          <figure className="section-figure">
            <img
              src="/placeholders/artist.svg"
              alt="Placeholder for art installation — swap in a photo of RadiaLumia, OPUS, or another installation."
              loading="lazy"
            />
          </figure>
          <div className="section-copy">
            <h2>Artist</h2>
            <p className="section-lede">
              Art that lights up the desert.
            </p>
            <p className="section-body">
              RadiaLumia. OPUS. INCENTER. The Empyrean Gate. Out The Other.
              Large-scale interactive sculpture, built with the Foldhaus collective and friends.
            </p>
            <a
              className="cta"
              href="https://www.foldhaus.com/radialumia"
              target="_blank"
              rel="noopener noreferrer"
            >
              RadiaLumia on Foldhaus <ArrowUpRight size={18} aria-hidden="true" />
            </a>
          </div>
        </div>
      </section>

      <section id="maker" className="snap section section-photo-left">
        <div className="section-inner">
          <figure className="section-figure">
            <img
              src="/placeholders/maker.svg"
              alt="Placeholder for maker work — swap in a photo of fabrication, PCBs, 3D prints, or workshop."
              loading="lazy"
            />
          </figure>
          <div className="section-copy">
            <h2>Maker</h2>
            <p className="section-lede">
              Built with 3D prints, PCBs, metal, fabric, and wood.
            </p>
            <p className="section-body">
              Hardware on ARM, ESP, and AVR. Firmware in C/C++ and assembly.
              Software in TypeScript, Node, and the cloud. Interfaces in React and Electron.
            </p>
            <a
              className="cta"
              href="https://www.indiegogo.com/projects/opus-burning-man-2019"
              target="_blank"
              rel="noopener noreferrer"
            >
              OPUS on Indiegogo <ArrowUpRight size={18} aria-hidden="true" />
            </a>
          </div>
        </div>
      </section>

      <section id="first" className="snap section section-photo-right">
        <div className="section-inner">
          <figure className="section-figure">
            <img
              src="/placeholders/first.svg"
              alt="Placeholder for FIRST Robotics — swap in a photo from competition, mentoring, or volunteering."
              loading="lazy"
            />
          </figure>
          <div className="section-copy">
            <h2>FIRST</h2>
            <p className="section-lede">
              Team 8 alum. Bloomhouse mentor. 2023 Volunteer of the Year.
            </p>
            <p className="section-body">
              Inspiration and Recognition of Science and Technology —
              ten years of giving back to the community that got me started.
            </p>
            <a
              className="cta"
              href="https://www.thebluealliance.com/event/2023casj#awards"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Trophy size={16} aria-hidden="true" />
              {" "}2023 Volunteer of the Year <ArrowUpRight size={18} aria-hidden="true" />
            </a>
          </div>
        </div>
      </section>

      <section id="connect" className="snap section section-connect">
        <div className="section-inner connect-inner">
          <figure className="section-figure portrait">
            <img
              src="/placeholders/portrait.svg"
              alt="Placeholder for a portrait photo of Cameron."
              loading="lazy"
            />
          </figure>
          <div className="section-copy">
